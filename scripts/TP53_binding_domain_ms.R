...
ggsave("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_4/dbd_snvs_combined_ms_4.png", combine_dbd_tissues, width = 3.75, height = 1.5, units = "in", dpi = 300)

#ggsave("results/am_large_clones_tissues.png", obsv_am_large_clones_tissue, width = 2.25, height = 1.5, units = "in", dpi = 300)
#ggsave("results/am_tissues.png", obsv_am_tissue, width = 2.5, height = 1.5, units = "in", dpi = 300)
#ggsave("results/dbd_proportion_tissues.png", dbd_prop_tissues, width = 1.5, height = 1.5, units = "in", dpi = 300)
...
ggsave("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_3/dbd_snvs_combined_ms_3.png", combine_dbd_blood, width = 3.75, height = 1.5, units = "in", dpi = 300)
