...
all_possible_muts_path <- file.path("/Volumes/feder-vol1/project/li_fraumeni/",
                                    "scripts/2025-09-30-dnds_prep/",
                                    "all_muts_annotated.tsv")
...
ggsave(paste0("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_2/", file_out), dnds_classic, width = 3.5, height = 1.5, units = "in", dpi = 300)
