...
ggsave("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_3/lollipop_blood_ms_3B_v2.png", lollipop_slide, width = 3.75, height = 1.5, units = "in", dpi = 300)
