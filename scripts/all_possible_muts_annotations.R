...
all_muts_vep_path <- file.path("/Volumes/feder-vol1/project/li_fraumeni",
...
all_muts_vep_clean <- all_muts_vep %>%
  ...
  select(Chromosome, Position, Mutation_ID, Consequence, SYMBOL)
...
## save file
all_possible_muts_annotated_path <- file.path("/Volumes/feder-vol1/project",
                                              "li_fraumeni/scripts",
                                              "2025-09-30-dnds_prep",
