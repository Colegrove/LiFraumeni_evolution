...
combined
ggsave("results/AlphaMissense_dist_proportion_supp.png", combined, width = 7, height = 3, units = "in", dpi = 300)
...
ggsave("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_3/AlphaMissense_tp53_ms_3.png", obsv_am_blood_groups, width = 3.5, height = 1.5, units = "in", dpi = 300)
