...
# }else{tissues = c("PBMC", "Buffy coat", "Urine cells")
#       subjects <- c("Family member A", "Family member B", 
#               "UW volunteer 1",  "UW volunteer 2",  "UW volunteer 3",  
#               "UW volunteer 4" , "UW volunteer 5" , "UW volunteer 6", 
#               "UW volunteer 7")}
...
observed_all_LFS %>% filter(Hugo_Symbol == "TP53")
...
#   mutate(Group = factor(Group, levels = c("non-LFS", "Patient", "Family member A", "Family member C")))


#patient_labels <- c("non-LFS"="non-LFS", "Patient" = "LFS01", "Family member A" = "LFS02", "Family member C" = "LFS03")
...
ggsave("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_3/dnds_tp53_grouped_ms_3.png", dnds_classic, width = 2, height = 2.2, units = "in", dpi = 300)

# }else{
#   ggsave("results/dnds_tp53_blood_LFS_supp_urine.png", dnds_classic, width = 3, height = 3, units = "in", dpi = 300)
# }
...
ggsave("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_3/dnds_tp53_nochemo_inset_ms_3.png", dnds_classic_no_chemo, width = 0.75, height = 0.75, units = "in", dpi = 300)
