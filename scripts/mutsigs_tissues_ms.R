...
ggsave("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_4/mutSigs_tissues_ms_4E.png",tissue_sigs, width = 3.75, height = 1.5, units = "in", dpi = 300)
