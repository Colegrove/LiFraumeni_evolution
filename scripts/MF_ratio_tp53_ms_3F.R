...
ggsave("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_3/MF_coding_ratio_ms3F.png", MF_coding_ratio, width = 1.5, height = 2.2, units = "in", dpi = 300)
