...
## uncomment to plot all tissues individually
...
family_title = "All family members"
...
show(lollipop_slide)
ggsave("results/lollipop_plot_slide_family.png", lollipop_slide, width = 6, height = 3, units = "in", dpi = 300)
