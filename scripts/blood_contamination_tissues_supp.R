...
skyscraper_blood_contamination %>% print(width = Inf)
...
#ggsave("results/blood_contamination_mutations.png", blood_contamination, width = 7, height = 4, units = "in", dpi = 300)
...
ggsave("results/blood_contamination_tissues.png", blood_contamination_slide, width = 5, height = 6, units = "in", dpi = 300)
