...
#path <- "/Users/huntc10/Documents/Documents/li_fraumeni/PR021_toHunter/inputs/COSMIC/external/tissues/"
path <- "/Users/huntc10/Documents/Documents/li_fraumeni/PR021_toHunter/inputs/COSMIC/external/blood/"
sbs_counts <- "blood_assignment_activities_26Dec.txt"
#sbs_stats <- "Decompose_Solution_Samples_Stats.txt"
# file3 <- "Decompose_Solution_Signatures.txt"
# file4 <- "Decomposed_MutationType_Probabilities.txt"
...
ggsave("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_2/mutSigs_blood_ms.png", blood_sigs, width = 2, height = 1.5, units = "in", dpi = 300)
