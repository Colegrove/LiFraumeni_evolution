...
ggsave("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_3/tp53_skyscraper_ms_3A.png", final_plot, width = 3.75, height = 3.25, units = "in", dpi = 300)
