...
coverage_df <- read_delim("/Volumes/feder-vol1/project/li_fraumeni/scripts/2025-10-02-bed_file_prep/cds_baits_overlap.bed", col_names = columns)

cds_annotations <- read_delim("/Volumes/feder-vol1/project/li_fraumeni/scripts/2025-09-30-dnds_prep/CHIP_cds_annotations.csv")
...
out_file <- "/Volumes/feder-vol1/project/li_fraumeni/scripts/2025-10-02-bed_file_prep/exon_proportions.tsv"
write_tsv(
  joined,
  out_file,
  col_names = TRUE
