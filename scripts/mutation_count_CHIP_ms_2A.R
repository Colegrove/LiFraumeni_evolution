...
ggsave("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_2/CHIP_mutation_count_ms_2A.png", combined_plot, width = 4, height = 3, units = "in", dpi = 300)
...
ggsave("/Users/huntc10/Library/CloudStorage/OneDrive-UW/Li-Fraumeni/Manuscript_figures/Fig_2/CHIP_mutation_count_cropped_ms_2A.png", combined_plot_legend_crop, width = 3.85, height = 3, units = "in", dpi = 300)
